    ...
    <>
      ...
      <div className="position-relative overflow-hidden">
        <div className="d-block d-md-none w-100 of-hidden height-200">
          <img src="/assets/banner/banner-desparacitacion.png" className="w-100 h-100"
            style={{objectFit: "cover", objectPosition: "center"}} alt="Banner desparasitacion veterinaria" />
        </div>
        <img src="/assets/banner/banner-desparacitacion.png" className="img-fluid w-100 d-none d-md-block"
        ...
        <div
          ...
          <div className="card-body fs-3 d-flex flex-column justify-content-center align-items-center h-100">
            <p className="card-text col-md-6 fs-1 fw-bold">Desparasitación</p>
          </div>
        </div>
      </div>
      ...
      <div className="container mt-1">
        <div className="row flex-column flex-md-row align-items-center">
          <div className="col-12 col-md-6 d-flex justify-content-center justify-content-md-end mb-4 mb-md-0">
            <img src="/assets/servicios/desparasitacion-1.webp" className="rounded-circle w-75 w-md-50"
              alt="Descripción de la foto" />
          </div>
          <div className="col-12 col-md-6 d-flex flex-column align-items-center text-center">
            <h2 className="text-info fs-1 fw-bold">Prevención frente a parásitos internos</h2>
      ...
      <div className="container mt-5 bg-light">
        <div className="row p-5">
          <div className="col-12 col-md-6 d-flex flex-column align-items-center text-center justify-content-center m-auto">
            <h2 className="text-info fs-1 fw-bold">¿Qué es la desparasitación?</h2>
            <p className="mt-3 px-3 px-md-0 fs-6" style={{textAlign: "justify"}}>
      ...
      <div className="container mt-5">
        <div className="row flex-column flex-md-row align-items-center">
          <div className="col-12 col-md-6 d-flex justify-content-center justify-content-md-end mb-4 mb-md-0">
            <img src="/assets/servicios/desparasitacion-2.webp" className="w-75 w-md-50"
              alt="Descripción de la foto" />
          </div>
          <div className="col-12 col-md-6 d-flex flex-column align-items-center text-center">
            <h2 className="text-info fs-1 fw-bold">¿Cuáles son los síntomas de los parásitos internos en nuestras mascotas?
            </h2>
      ...
      <div className="row container col-12 m-auto mt-5">
        <h2 className="text-info fs-1 fw-bold text-center">Preguntas frecuentes sobre desparasitación de mascotas</h2>
