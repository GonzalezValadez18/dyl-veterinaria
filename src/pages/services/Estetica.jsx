    ...
    <>
      ...
      <div className="position-relative overflow-hidden">
        <div className="d-block d-md-none w-100 of-hidden height-200">
          <img src="/assets/banner/banner-estetica.jpg" className="w-100 h-100"
            style={{objectFit: "cover", objectPosition: "center"}} alt="Banner veterinaria" />
        </div>
        <img src="/assets/banner/banner-estetica.jpg" className="img-fluid w-100 d-none d-md-block"
        ...
        <div
          ...
          <div className="card-body fs-3 d-flex flex-column justify-content-center align-items-center h-100">
            <p className="card-text col-md-6 fs-1 fw-bold">Estetica Canina</p>
          </div>
        </div>
      </div>
      ...
      <div className="container col-12 m-auto mt-5">
        <h2 className="text-info fs-1 fw-bold text-center">¡Agenda abierta!</h2>
        <hr className="hr" />
      </div>
        ...
        <div className="container mt-5 p-5">
          <div className="row flex-column flex-md-row align-items-center">
            <div className="col-12 col-md-6 d-flex justify-content-center justify-content-md-end mb-4 mb-md-0">
              <img src="/assets/servicios/estetica-1.webp" className="rounded-circle w-75 w-md-50"
                alt="Descripción de la foto" />
            </div>
            <div className="col-12 col-md-6 d-flex flex-column align-items-center text-center">
              <h2 className="text-info fs-1 fw-bold">Servicio de estetica canina</h2>
              <p className="mt-3 px-3 px-md-0 fs-4" style={{textAlign: "justify"}}>
                Todos los servicios de estética canina incluyen
              </p>
              <ul className="mt-3 px-3 px-md-0 fs-5" style={{textAlign: "justify"}}>
      ...
      {/* Packages */}
      <div className="row container col-12 m-auto mt-5 d-flex justify-content-center gap-5" style={{alignItems: "flex-start"}}>
        <h2 className="text-info fs-1 fw-bold text-center">Tamaños de perro</h2>
        <p className="text-center fs-4">El costo del servicio dependera del tamaño de su mascota</p>
          ...
          <div className="accordion" id="dogSizeAccordion">
            ...
            <div className="accordion-item">
              <div className="text-center pt-3">
                <img src="/assets/servicios/estetica-2.webp"
                  style={{width: "150px", height: "150px", objectFit: "cover"}} alt="Imagen del servicio" />
              </div>
              <h2 className="accordion-header" id="headingSmall">
                <button className="accordion-button justify-content-center" type="button" data-bs-toggle="collapse"
                  data-bs-target="#collapseSmall" aria-expanded="true" aria-controls="collapseSmall"
                  style={{background: "none", boxShadow: "none", fontSize: "1.3rem"}}>
                  Perros pequeños (chicos)
                </button>
              </h2>
              <div id="collapseSmall" className="accordion-collapse collapse show" aria-labelledby="headingSmall"
                data-bs-parent="#dogSizeAccordion">
                <div className="accordion-body">
                  <strong>Características:</strong>
                  <ul className="mt-3 px-3 px-md-0 fs-6" style={{textAlign: "justify"}}>
            ...
            <div className="accordion-item">
              <div className="text-center pt-3">
                <img src="/assets/servicios/estetica-3.webp"
                  style={{width: "150px", height: "150px", objectFit: "cover"}} alt="Imagen del servicio" />
              </div>
              <h2 className="accordion-header" id="headingMedium">
                <button className="accordion-button justify-content-center collapsed" type="button"
                  data-bs-toggle="collapse" data-bs-target="#collapseMedium" aria-expanded="false"
                  aria-controls="collapseMedium" style={{background: "none", boxShadow: "none", fontSize: "1.3rem"}}>
                  Perros medianos
                </button>
              </h2>
              <div id="collapseMedium" className="accordion-collapse collapse" aria-labelledby="headingMedium"
                data-bs-parent="#dogSizeAccordion">
                <div className="accordion-body">
                  <strong>Características:</strong>
                  <ul className="mt-3 px-3 px-md-0 fs-6" style={{textAlign: "justify"}}>
            ...
            <div className="accordion-item">
              <div className="text-center pt-3">
                <img src="/assets/servicios/estetica-4.webp"
                  style={{width: "150px", height: "150px", objectFit: "cover"}} alt="Imagen del servicio" />
              </div>
              <h2 className="accordion-header" id="headingLarge">
                <button className="accordion-button justify-content-center collapsed" type="button"
                  data-bs-toggle="collapse" data-bs-target="#collapseLarge" aria-expanded="false"
                  aria-controls="collapseLarge" style={{background: "none", boxShadow: "none", fontSize: "1.3rem"}}>
                  Perros grandes
                </button>
              </h2>
              <div id="collapseLarge" className="accordion-collapse collapse" aria-labelledby="headingLarge"
                data-bs-parent="#dogSizeAccordion">
                <div className="accordion-body">
                  <strong>Características:</strong>
        ...
        <div className="card info-hover-card d-none d-md-flex" id="card1" style={{width: "20rem"}}>
          <img src="/assets/servicios/estetica-2.webp" className="card-img-top  img-uniforme"
            alt="Imagen del servicio" />
          <div className="card-body">
            <h5 className="card-title">Perros pequeños (chicos)</h5>
            <div className="card-info">
              Características:
              <ul className="mt-3 px-1 px-md-0 fs-6" style={{textAlign: "justify"}}>
                <li>Peso: Hasta 10 kg</li>
                <li>Altura: Menos de 30 cm al hombro</li>
                <li>Esperanza de vida: 12–16 años (a veces más)</li>
                <li>Temperamento: Vivos, alertas, pueden ser territoriales</li>
        ...
        <div className="card info-hover-card d-none d-md-flex" id="card2" style={{width: "20rem"}}>
          <img src="/assets/servicios/estetica-3.webp" className="card-img-top  img-uniforme"
            alt="Imagen del servicio" />
          <div className="card-body">
        ...
        <div className="card info-hover-card d-none d-md-flex" id="card3" style={{width: "20rem"}}>
          <img src="/assets/servicios/estetica-4.webp" className="card-img-top  img-uniforme"
            alt="Imagen del servicio" />
          <div className="card-body">
        ...
        <div className="d-block mt-3">
          <div className="accordion" id="accordionFaq">
            ...
            <div className="accordion-item">
              ...
              <div id="collapseFaq4" className="accordion-collapse collapse" aria-labelledby="headingFaq4"
                data-bs-parent="#accordionFaq">
                <div className="accordion-body">
